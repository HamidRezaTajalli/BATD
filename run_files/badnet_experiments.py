            ...
            for target_label in target_labels:
                for epsilon in epsilon_list:
                    for trigger_size in trigger_size_list:
                        ...
                        command = f"srun python BadNet.py --dataset_name {dataset} --model_name {model} --target_label {target_label} --epsilon {epsilon} --trigger_size {trigger_size} --exp_num {exp_num}"
