                ...
                for epsilon in epsilon_list:
                    for prune_rate in prune_rate_list:
                        for mu in mu_list:
                            ...
                            command = f"srun python pruning_trial.py --dataset_name {dataset} --model_name {model} --target_label {target_label} --mu {mu} --beta {beta} --lambd {lambd} --epsilon {epsilon} --exp_num {exp_num} --prune_rate {prune_rate}"
