...
def attack_step_by_step(args, use_saved_models, use_existing_trigger):
    ...
    if model_name == "ftt":
        model.load_model('/home/htajalli/prjs0962/repos/BATD/saved_models/converted_clean/ftt_higgs.pth')
    elif model_name == "tabnet":
        model.load_model('/home/htajalli/prjs0962/repos/BATD/saved_models/converted_clean/tabnet_higgs.pth.zip')
    elif model_name == "saint":
        model.load_model('/home/htajalli/prjs0962/repos/BATD/saved_models/converted_clean/saint_higgs.pth')
    elif model_name == "xgboost":
        model.load_model('/home/htajalli/prjs0962/repos/BATD/saved_models/converted_clean/xgboost_higgs.pth.zip')
    else:
        raise ValueError(f"Model {model_name} is not available. Please choose from: {available_models}")
    ...
    # else:
    #     attack.optimize_trigger(num_epochs=120) # optimize the trigger
    ...
    # If using catboost or xgboost, then we need to define a black box model.
