            ...
            for target_label in target_labels:
                for epsilon in epsilon_list:
                    for mu in mu_list:
                        ...
                        command = f"srun python step_by_step_higgs.py --dataset_name {dataset} --model_name {model} --target_label {target_label} --mu {mu} --beta {beta} --lambd {lambd} --epsilon {epsilon} --exp_num {exp_num}"
