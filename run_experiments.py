...
model_list = ['tabnet', 'saint']
dataset_list = ["aci", "bm", "credit_card", "covtype", "eye_movement"]
dataset_list = ["higgs"]
...
#                         # create the command to run the experiment
#                         command = f"srun python ss.py --dataset_name {dataset} --model_name {model} --target_label {target_label} --mu {mu} --beta {beta} --lambd {lambd} --epsilon {epsilon} --exp_num {exp_num}"
